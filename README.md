...
## As i have a small task to do with the command sed with the /etc/passwd file i will start by using the module user to create multiple users as well as also directly see the syntax for using loops in a playbook
